...
export function NewContentStateProvider({ children }: { children: ReactNode }) {
  const initialValues: Inputs = {
    ...
    deliveryRepoSummary: "theSampleSummary",
    deliveryRepoDescription: "theDescription",
    deliveryRepoReleaseCategory: "Tech-Preview",
    deliveryRepoHostLevelAccess: "Privileged",
    deliveryRepoImageUsageType: "Component image",
    deliveryRepoImageOwner: "dperique@redhat.com",
    deliveryRepoProductManager: "Test Product Manager",
    deliveryRepoProgramManager: "Test Program Manager",
